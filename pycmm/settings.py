...
# Defining default colors for each xls cell type
CELL_TYPE_RARE = 'RARE'
CELL_TYPE_HARMFUL = 'HARMFUL'
CELL_TYPE_HET_SHARED = 'SHARED'
CELL_TYPE_HOM_SHARED = 'HOM_SHARED'

DFLT_CELL_COLORS = {}
DFLT_CELL_COLORS[CELL_TYPE_RARE] = 'YELLOW'
DFLT_CELL_COLORS[CELL_TYPE_HARMFUL] = 'LIGHT_BLUE'
DFLT_CELL_COLORS[CELL_TYPE_HET_SHARED] = 'SILVER'
DFLT_CELL_COLORS[CELL_TYPE_HOM_SHARED] = 'GRAY25'
