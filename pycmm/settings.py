...
## > > > > > > > > > > > > > Mutation report < < < < < < < < < <
MUTREP_PIPELINE_DESCRIPTION = "A flow to control a pipeline to process mutation report"
MUTREP_PIPELINE_DFLT_LOG_FILE = "mutrep_pipeline"
MUTREP_ALLOC_TIME = "6:00:00"

MUTREP_CREATE_JOB_SETUP_FILE_DESCRIPTION = "An applicationt to generate job setup file for MUTREP_PIPELINE"
